...
const renderSlider= (images)=> {
    images.forEach(images => {
        ...
        elementSlider.innerHTML=`<div class="carousel-inner">
        <div class="carousel-item active">
          <img class="w-100 slider1-desktop" src=${images.images1} alt="...">
          <img class="w-100 slider1-mobile" src=${images.imagen3} alt="Banner de televisión">
        </div>
        <div class="carousel-item">
          <img class="w-100 slider2-desktop" src=${images.images2} alt="...">
          <img class="w-100 slider2-mobile" src=${images.images4} alt="Banner de relojes">
        </div> 
